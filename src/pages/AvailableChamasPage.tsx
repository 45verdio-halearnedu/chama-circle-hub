...
import { Users, DollarSign, Star, MapPin, Calendar, Shield, CheckCircle } from 'lucide-react';
...
const AvailableChamasPage: React.FC = () => {
  ...
  const handleSubmitApplication = () => {
    ...
    toast({
      ...
      description: `Your application to join ${selectedChama?.name} has been submitted. You'll receive a response within 24 hours.`,
    });
